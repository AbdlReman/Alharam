...
const AllInOneKitPage = () => {
  ...
  useEffect(() => {
    ...
    filtered = filtered.filter((product) =>
      product.category && (Array.isArray(product.category)
        ? product.category.includes("allinonekit")
        : product.category === "allinonekit")
    );
  ...
  return (
    <Fragment>
      <SEO
        titleTemplate="All In One Kit - Alharam"
        description="Shop All In One Kit products at Alharam. Complete bundles for easy setup."
      />
                ...
                <div className="col-lg-3 order-2 order-lg-1">
                  <ShopSidebar
                    products={[...products].filter(p => {
                      const inCategory = p.category && (Array.isArray(p.category) ? p.category.includes("allinonekit") : p.category === "allinonekit");
                  ...
                  <div className="category-header mb-4">
                    <div className="row">
                      <div className="col-12">
                        <h1 className="category-title">All In One Kit</h1>
                        <p className="category-description">
                          Complete bundles with everything you need in one kit.
                        </p>
                      </div>
                    </div>
                  </div>
