...
const MobileAccessoriesPage = () => {
  ...
  return (
    <Fragment>
      <SEO 
        titleTemplate="Mobile Accessories - Alharam"
        title="Mobile Accessories - Chargers, Cables, Power Banks & More"
        description="Shop premium mobile accessories at Alharam. Wide range of chargers, cables, earphones, power banks, and essential mobile gadgets. Quality products with fast delivery across Pakistan." 
        keywords="mobile accessories, phone accessories, mobile chargers, USB cables, power banks, earphones, mobile gadgets, Pakistan"
      />
